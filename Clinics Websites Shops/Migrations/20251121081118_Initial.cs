        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasEmergencyServices = table.Column<bool>(type: "bit", nullable: false),
                    HasPharmacy = table.Column<bool>(type: "bit", nullable: false),
                    HasLaboratory = table.Column<bool>(type: "bit", nullable: false),
                    HasRadiology = table.Column<bool>(type: "bit", nullable: false),
                    NumberOfRooms = table.Column<int>(type: "int", nullable: true),
                    NumberOfBeds = table.Column<int>(type: "int", nullable: true),
                    ParkingCapacity = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClinicDescription = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ...
                    AppointmentSlotInterval = table.Column<int>(type: "int", nullable: false),
                    ...
                    SendSmsReminders = table.Column<bool>(type: "bit", nullable: false),
                    SendEmailReminders = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    RequirePaymentAtBooking = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    SupportedLanguages = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ...
                    EnablePatientPortal = table.Column<bool>(type: "bit", nullable: false),
                    EnableOnlinePayments = table.Column<bool>(type: "bit", nullable: false),
                    EnableTelehealth = table.Column<bool>(type: "bit", nullable: false),
                    EnablePrescriptionManagement = table.Column<bool>(type: "bit", nullable: false),
                    EnableLabResults = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InsuranceCoverageAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ...
                    AllowSmsNotifications = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicalDegree = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    AdditionalCertifications = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    YearsOfExperience = table.Column<int>(type: "int", nullable: false),
                    MedicalSchool = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ...
                    DirectPhone = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlockNewAppointments = table.Column<bool>(type: "bit", nullable: false),
                    CancelExistingAppointments = table.Column<bool>(type: "bit", nullable: false),
                    NotificationMessage = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    ReplacementDoctorId = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                    ModifiedBy = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DoctorHolidays_Doctors_ReplacementDoctorId",
                        column: x => x.ReplacementDoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DoctorSchedules_ClinicLocations_LocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ResultNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ...
                    AttachmentFileType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicalResults_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_MedicalResults_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_MedicalResults_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MedicalResults_Reports_ReportId",
                        column: x => x.ReportId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorHolidays_ReplacementDoctorId",
                table: "DoctorHolidays",
                column: "ReplacementDoctorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalResults_AppointmentId",
                table: "MedicalResults",
                column: "AppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalResults_DoctorId",
                table: "MedicalResults",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalResults_PatientId",
                table: "MedicalResults",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalResults_ReportId",
                table: "MedicalResults",
                column: "ReportId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalResults_ResultNumber",
                table: "MedicalResults",
                column: "ResultNumber",
                unique: true);
